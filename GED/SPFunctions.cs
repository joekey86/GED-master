...
namespace GED
{
    class SPFunctions
    {
        ...
        public static void getStatus (string webUrl, int Id , string listName)
        {
            using (ClientContext ctx = SPConnection.GetSPOLContext(webUrl))
            {
                ...
                if (!string.Equals(status, OldStatus))
                {
                    ...
                    switch (status)
                    {
                        ...
                        case "En attente de validation":
                            ...
                            SendEmail(ctx, (FieldUserValue[])item["Validateur_x0028_s_x0029_"], "GED - Un document est en attente de validation", 2, (FieldUserValue[])item["Email_x0020_envoy_x00e9__x0020_aux_x0020_V_x00e9_rificateur_x0028_s_x0029_"], item);
        ...
        public static void UpdateReceivedEmail(ListItem item,string fieldName, FieldUserValue[] usersToUpdate, FieldUserValue[] usersToAdd )
        {
            if (usersToAdd != null)
            {
                ...
                {
                    if (usersToAdd.Where(a => a.Email == usr.Email) == null)
                    {
                        users.Add(usr);
                    }
                }
                int totalCount = usersToUpdate.Length + users.Count;
        ...
        public static string EmailBody(int index, ListItem item, string useremail,FieldUserValue[] users = null)
        {
            ...
            else if(index == 4)
            {
                body = @"Bonjour,
                        ...
                        Veuillez cliquer sur ce lien pour valider la lecture du document:<br/><br/>
